    ...
    <div id="contact" className={clsses}>
      <div className="left w-1/2 flex items-center justify-center -mb-36">
        <div className="w-full md:w-[80%] mb-8 md:mb-0 text-center md:text-left">
          ...
          <p className="mb-6 text-lg text-white ">
            Alternatively, check out my <a href="https://drive.google.com/drive/u/0/folders/17UzH1KU9MGzxsOxYyavrz0zNcfpzKduP" download className='text-[#D4A03E] mt-5 cursor-pointer hover:underline  '>Resume</a>
          </p>
          ...
          <div className="flex justify-center md:justify-start space-x-4 mb-14">
            <a href="mailto:karanraj7462@gmail.com" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.linkedin.com/in/raj-karan-1126a0262/" target="_blank" rel="noopener noreferrer">
              <button className="p-2 rounded-full bg-transparent border border-[#D4A03E] text-[#D4A03E] hover:bg-[#D4A03E] hover:text-black transition-colors duration-300 text-3xl">
            ...
            <a href="https://www.instagram.com/rj_karan_x_/" target="_blank" rel="noopener noreferrer">
              <button className="p-2 rounded-full bg-transparent border border-[#D4A03E] text-[#D4A03E] hover:bg-[#D4A03E] hover:text-black transition-colors duration-300 text-3xl">
                <AiFillInstagram />
      ...
      <div className=" flex justify-between absolute bottom-0 left-0 right-0 text-center p-4 text-gray-700 text-sm">
        ...
        <p>© {new Date().getFullYear()} Raj Karan. All rights reserved.</p>

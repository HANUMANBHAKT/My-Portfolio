...
export default function AboutSection() {
  ...
  return (
    ...
    >
      ...
      >
        {/* <img src={Raj} alt="Raj Karan" className="md:w-9/12 lg:w-9/12 sm:w-9/12 w-full" /> */}
        <Image />
      ...
      <div className="details transform transition-all duration-300 absolute md:right-1/2 flex md:flex-col flex-row gap-6 items-center justify-center mt-[90%] md:translate-x-6 md:hover:translate-x-0 md:mt-5 lg:mt-5 bg-white/30 p-3 rounded-lg opacity-80 hover:opacity-100  ">
        ...
        <a href="tel:+917004180658" className="text-black text-3xl hover:text-gray-700 cursor-pointer transition-colors duration-200 -mb-2">
          <MdOutlinePhoneAndroid />
        </a>
        <a href="/RajKaran_Resume.pdf" download className="text-black text-3xl hover:text-gray-700 cursor-pointer transition-colors duration-200 -mb-3">
          <PiReadCvLogoFill />
        </a>
        <a href="mailto:karanraj7462@gmail.com" className=" text-black text-3xl hover:text-gray-700 cursor-pointer transition-colors duration-200 -mb-2">
          <IoMdMail />
        </a>
      </div>
      ...
      <div className={` text-center md:text-left rightAbout mt-10 md:mt-0 lg:mt-0 md:w-1/2 xl:h-screen xl:flex xl:justify-center xl:flex-col  relative md:pt-5 p-4   h-full   shadow-lg transition-transform duration-700 delay-500 ${isVisible ? 'animate-slideInRight' : 'opacity-0'
        ...
        <p className="md:text-lg  2xl:text-2xl text-sm leading-relaxed font-medium  mb-3">
          I’m Raj, a dedicated <span className="font-semibold text-[#D4A03E]">Software Engineer</span> A results-driven software developer with expertise in full-stack web development, specializing in the MERN stack. Proficient in
          developing scalable applications with a strong focus on clean code, user-friendly design, and robust functionality. Experienced in
          collaborating within agile teams to deliver high-impact solutions.
        </p>

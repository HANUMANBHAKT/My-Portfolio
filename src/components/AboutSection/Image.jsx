    ...
    <div className="max-w-3xl mx-auto">
      ...
      >
        <img
          ...
          className={`md:w-9/12 lg:w-9/12 sm:w-9/12 w-full md:ml-20 lg:ml-20 h-auto transition-all duration-500 ease-out ${isHovered ? 'glow-effect pulse-effect tilt-scale' : ''
            }`}
        />
        <div className={`
        ...
        `}>
          <p className="text-lg font-bold shadow-sm">Raj Karan</p>
